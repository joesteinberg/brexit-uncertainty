...
#define NT 100 // number of time periods
...
#define TCH0 4 // 2015: year tariff reform announced
#define TCH1 5 // 2016: year of tariff reform
#define TCH2 11 // last year in which tariffs can rise

// these must be hard-coded because they govern how much memory must be allocated
//#define CH_SIMPLE // simple China exercise: tariffs fall in 2016, may rise in period TCH1
#define CH_COMPLEX // complex China exercise: tariffs fall in 2016, can rise every year through period TCH1

#ifdef CH_SIMPLE
#define NHIST_CH 3
#else
#define NHIST_CH 8 // must be equal to 2+TCH2-TCH1!!!!
#endif
